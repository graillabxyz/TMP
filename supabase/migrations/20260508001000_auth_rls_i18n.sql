...
values
  ...
  ((select id from public.supplier_accounts where slug = 'istanbul-packaging-lab'), 'Rigid cosmetics box', 'Boîte rigide cosmétique', 'Premium rigid cosmetics packaging with export-ready finishing.', 'Packaging cosmétique rigide premium avec finitions prêtes pour l’export.', 'Packaging', 'Emballage', '1,000 units', 'https://images.unsplash.com/photo-1607344645866-009c320f75c4?auto=format&fit=crop&w=900&q=80', 'published', 10),
