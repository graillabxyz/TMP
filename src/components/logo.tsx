...
export function Logo({ compact = false, className, href = "/" }: LogoProps) {
  return (
    ...
    >
      <span className="relative flex size-11 shrink-0 items-center justify-center overflow-hidden rounded-md border border-gold-300/[0.35] bg-gold-300/10 shadow-glow">
        <Image
      ...
      {!compact && (
        <span className="flex h-11 min-w-0 flex-col justify-center max-[380px]:hidden">
