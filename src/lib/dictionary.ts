  ...
  en: {
    ...
    dashboard: {
      ...
      productManager: {
        ...
        detailsBody:
          "Give buyers the specific details they need to understand and compare your product.",
        productTitlePlaceholder: "e.g. Heavyweight organic cotton hoodie",
        productTitleHelp:
          "Include the product type, material, and most important specification.",
        category: "Category",
        categoryPlaceholder: "Select a category",
        productDescription: "Description",
        descriptionPlaceholder:
          "Describe materials, dimensions, available options, certifications, and production capabilities.",
        descriptionHelp:
          "Use clear specifications and avoid contact details or promotional claims.",
        characters: "characters",
        orderTitle: "Order and pricing",
        orderBody:
          "Set realistic trade terms. Leave pricing empty when every order requires a custom quote.",
        minimumOrderQuantity: "Minimum order quantity",
        moqPlaceholder: "e.g. 100",
        moqHelp: "The smallest quantity you can supply in one order.",
        ...
        publishingTitle: "Ready to list?",
        publishingBody:
          "Publish immediately for buyers to discover, or keep this listing as a private draft.",
        ...
        integerError: "Enter a whole number of at least 1.",
        numberError: "Enter a valid positive amount.",
        priceRangeError:
          "Maximum price must be equal to or greater than minimum price.",
        invalidOptionError: "Choose a valid option.",
        imageRequiredError: "Add at least one product photo.",
        imageInvalidError: "Use valid JPG, PNG, or WebP files up to 5 MB each.",
        imageCountError: "Add no more than five product photos.",
        formError: "Review the highlighted fields before continuing.",
        categoryError:
        ...
        notFoundError: "This product is no longer available to edit.",
  ...
  fr: {
    ...
    dashboard: {
      ...
      productManager: {
        ...
        detailsTitle: "Informations produit",
        detailsBody:
          "Donnez aux acheteurs les informations précises nécessaires pour comprendre et comparer votre produit.",
        productTitlePlaceholder: "ex. Sweat à capuche épais en coton bio",
        productTitleHelp:
          "Indiquez le type de produit, la matière et la caractéristique principale.",
        category: "Catégorie",
        categoryPlaceholder: "Sélectionner une catégorie",
        productDescription: "Description",
        descriptionPlaceholder:
          "Décrivez les matières, dimensions, options, certifications et capacités de production.",
        descriptionHelp:
          "Utilisez des spécifications claires, sans coordonnées ni promesses promotionnelles.",
        characters: "caractères",
        orderTitle: "Commande et prix",
        orderBody:
          "Définissez des conditions commerciales réalistes. Laissez les prix vides si chaque commande nécessite un devis.",
        minimumOrderQuantity: "Quantité minimale",
        moqPlaceholder: "ex. 100",
        moqHelp:
          "La plus petite quantité que vous pouvez fournir par commande.",
        ...
        publishingTitle: "Prêt à publier ?",
        publishingBody:
          "Publiez immédiatement pour être découvert par les acheteurs, ou conservez ce listing en brouillon privé.",
        publishProduct: "Publier le produit",
        updatePublished: "Mettre à jour le produit publié",
        ...
        integerError: "Saisissez un nombre entier supérieur ou égal à 1.",
        numberError: "Saisissez un montant positif valide.",
        priceRangeError:
          "Le prix maximum doit être supérieur ou égal au prix minimum.",
        invalidOptionError: "Choisissez une option valide.",
        imageRequiredError: "Ajoutez au moins une photo du produit.",
        imageInvalidError:
          "Utilisez des fichiers JPG, PNG ou WebP valides de 5 Mo maximum chacun.",
        imageCountError: "Ajoutez au maximum cinq photos du produit.",
        formError: "Vérifiez les champs signalés avant de continuer.",
        categoryError:
          "Cette catégorie n’est plus disponible. Choisissez-en une autre.",
        saveError:
          "Le produit n’a pas pu être enregistré. Vos saisies sont conservées ; réessayez.",
        notFoundError: "Ce produit n’est plus disponible à la modification.",
        imageError:
...
const turkishDictionary = {
  ...
  dashboard: {
    ...
    productManager: {
      ...
      detailsTitle: "Ürün bilgileri",
      detailsBody:
        "Alıcıların ürününüzü anlaması ve karşılaştırması için gereken net bilgileri ekleyin.",
      productTitlePlaceholder: "ör. Ağır gramajlı organik pamuk kapüşonlu",
      productTitleHelp:
        "Ürün türünü, malzemeyi ve en önemli teknik özelliği belirtin.",
      category: "Kategori",
      categoryPlaceholder: "Kategori seçin",
      productDescription: "Açıklama",
      descriptionPlaceholder:
        "Malzemeleri, ölçüleri, seçenekleri, sertifikaları ve üretim kapasitesini açıklayın.",
      descriptionHelp:
        "Net teknik bilgiler kullanın; iletişim bilgisi veya reklam iddiası eklemeyin.",
      characters: "karakter",
      orderTitle: "Sipariş ve fiyatlandırma",
      orderBody:
        "Gerçekçi ticari koşullar belirleyin. Her sipariş özel teklif gerektiriyorsa fiyatları boş bırakın.",
      minimumOrderQuantity: "Minimum sipariş miktarı",
      moqPlaceholder: "ör. 100",
      moqHelp: "Tek siparişte sağlayabileceğiniz en düşük miktar.",
      ...
      publishingTitle: "Yayınlamaya hazır mı?",
      publishingBody:
        "Alıcıların hemen keşfetmesi için yayınlayın veya ilanı özel taslak olarak saklayın.",
      ...
      integerError: "En az 1 olan bir tam sayı girin.",
      numberError: "Geçerli bir pozitif tutar girin.",
      priceRangeError:
        "Maksimum fiyat minimum fiyata eşit veya daha yüksek olmalıdır.",
      invalidOptionError: "Geçerli bir seçenek belirleyin.",
      imageRequiredError: "En az bir ürün fotoğrafı ekleyin.",
      imageInvalidError:
        "Her biri en fazla 5 MB olan geçerli JPG, PNG veya WebP dosyaları kullanın.",
      imageCountError: "En fazla beş ürün fotoğrafı ekleyin.",
      formError: "Devam etmeden önce işaretlenen alanları kontrol edin.",
      categoryError:
        "Bu kategori artık kullanılamıyor. Başka bir kategori seçin.",
      saveError:
        "Ürün kaydedilemedi. Girdileriniz korundu; lütfen tekrar deneyin.",
      notFoundError: "Bu ürün artık düzenlenemiyor.",
      imageError:
